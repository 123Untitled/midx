#ifndef ml_language_parser_hpp
#define ml_language_parser_hpp
...
namespace ml {
	...
	class parser final {
		...
		private:
			...
			/* self type */
			using self = ml::parser;


			// -- private members ---------------------------------------------

			/* parser context */
			ml::parser_context _context;

			/* state driver */
			ml::state_driver _driver;
		...
		public:
			...
			/* parse */
			auto parse(const ml::mapped_file&, ml::project&) -> void;
